...
class Sampler {
 ...
 public:
  ...
  ~Sampler();
  /*  samples are generated by going through each pixel horizontally from the
      upper left corner to the lower right corner of the screen, generating
      samplings^2 number of samples per pixel.  */
